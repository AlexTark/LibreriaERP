...
namespace LibreriaERP.Clases.FacturasVenta
{
    [Table(Name = TABLE_LINEASFACTURA)]
    public class LineasFacturaVenta : DataObjectEntity<LineasFacturaVenta>
    {
        public const String TABLE_LINEASFACTURA = "LineasFactura";
