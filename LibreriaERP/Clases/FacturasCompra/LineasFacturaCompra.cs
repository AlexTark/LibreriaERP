...
namespace LibreriaERP.Clases.FacturasCompra
{
    [Table(Name = TABLE_LINEASFACTURA)]
    public class LineasFacturaCompra : DataObjectEntity<LineasFacturaCompra>
    {
        public const String TABLE_LINEASFACTURA = "LineasFacturaCompra";
