...
{
    [Table(Name = TABLE_PRESUPUESTOVENTA)]
    public class PresupuestoVenta : DataObjectEntity<PresupuestoVenta>
    {
        public const String TABLE_PRESUPUESTOVENTA = "PresupuestoVenta";
