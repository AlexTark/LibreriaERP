...
namespace LibreriaERP.Clases.PresupuestosVenta
{
    [Table(Name = TABLE_LINEASPRESUPUESTOVENTA)]
    public class LineasPresupuestoVenta : DataObjectEntity<LineasPresupuestoVenta>
    {
        public const String TABLE_LINEASPRESUPUESTOVENTA = "LineasPresupuestoVenta";
        ...
        [Column(Name = "PrecioCoste", DbType = DbType.Double)]
