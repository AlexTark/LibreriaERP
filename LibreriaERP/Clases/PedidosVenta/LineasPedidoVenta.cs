...
namespace LibreriaERP.Clases.PedidosVenta
{
    [Table(Name = TABLE_LINEASPEDIDOVENTA)]
    public class LineasPedidoVenta : DataObjectEntity<LineasPedidoVenta>
    {
        public const String TABLE_LINEASPEDIDOVENTA = "LineasPedidoVenta";
