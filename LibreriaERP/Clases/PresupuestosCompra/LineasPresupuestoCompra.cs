...
namespace LibreriaERP.Clases.PresupuestosCompra
{
    [Table(Name = TABLE_LINEASPRESUPUESTOCOMPRA)]
    public class LineasPresupuestoCompra : DataObjectEntity<LineasPresupuestoCompra>
    {
        public const String TABLE_LINEASPRESUPUESTOCOMPRA = "LineasPresupuestoCompra";
