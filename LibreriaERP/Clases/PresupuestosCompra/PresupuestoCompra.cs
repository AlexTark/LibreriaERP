...
{
    [Table(Name = TABLE_PRESUPUESTOCOMPRA)]
    public class PresupuestoCompra : DataObjectEntity<PresupuestoCompra>
    {
        public const String TABLE_PRESUPUESTOCOMPRA = "PresupuestoCompra";
