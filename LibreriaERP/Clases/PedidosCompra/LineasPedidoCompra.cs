...
{
    [Table(Name = TABLE_LINEASPEDIDOCOMPRA)]
    public class LineasPedidoCompra : DataObjectEntity<LineasPedidoCompra>
    {
        public const String TABLE_LINEASPEDIDOCOMPRA = "LineasPedidoCompra";
